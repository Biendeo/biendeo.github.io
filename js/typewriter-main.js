...
var dialogueProceed = function(trigger, input) {
	...
	switch(trigger) {
		case 0:
			commenceTypeWriter(".display-content", "Welcome to the Biendeo website!" + "<br />" + "Input some words in the box below, or click the links to see things!" + "<br /><br />" + "Stuck? Type " + inputToAHrefFunction("help") + ".", 20);
			break;
		case 1:
		default:
			commenceTypeWriter(".display-content", "I don't know what you mean by <i>" + input + "</i>. Try something else, or type " + inputToAHrefFunction("help") + ".", 20);
			break;
		case 2:
			switch(screen) {
				case 0:
				default:
					commenceTypeWriter(".display-content", "Sure, I guess... You should just type " + inputToAHrefFunction("help") + " in case.", 20);
					break;
			}
			screen = 2;
			break;
